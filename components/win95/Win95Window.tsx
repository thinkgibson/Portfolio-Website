        ...
        >
            ...
            <div className="bg-win95-gray px-2 py-2 border-b border-win95-gray-inactive text-[18px] font-win95 flex shrink-0 gap-[2px] select-none relative">
                <div className="relative">
                    <span
                        className={`p-[5px] cursor-default font-normal ${activeMenu === 'File' ? 'win95-beveled-inset bg-win95-gray' : 'win95-beveled'}`}
                ...
                <div className="relative">
                    <span
                        className={`p-[5px] cursor-default font-normal ${activeMenu === 'Search' ? 'win95-beveled-inset bg-win95-gray' : 'win95-beveled'}`}
                ...
                <div className="relative">
                    <span
                        className={`p-[5px] cursor-default font-normal ${activeMenu === 'Help' ? 'win95-beveled-inset bg-win95-gray' : 'win95-beveled'}`}
