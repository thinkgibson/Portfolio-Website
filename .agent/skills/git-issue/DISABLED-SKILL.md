...
### 4. Git Issue Type
- **Enhancement:** Include in the implementation plan a full understanding of the newly added features and how they will impact the existing codebase. Also include user flows.
- **Bug:** Include in the implementation plan a full understanding of the bug and how it will impact the existing codebase. Also include other areas of the code that may be affected by the bug. Make sure to include new test cases for the bug to prevent it from reoccurring in the future.
