...
5. Create git branch
    ...
    - See [commit-git skill](file:///i:/code/VSCode/PortfolioWebsite/.agent/skills/commit-git/SKILL.md) for commit details (Branch creation should be handled prior to coding).
...
11. Create pull request and merge changes
    - Use [create-pr-git skill](file:///i:/code/VSCode/PortfolioWebsite/.agent/skills/create-pr-git/SKILL.md) to open a PR.
    - Use [merge-git skill](file:///i:/code/VSCode/PortfolioWebsite/.agent/skills/merge-git/SKILL.md) to land the changes.
    - See [Error Handling section](file:///i:/code/VSCode/PortfolioWebsite/.agent/skills/merge-git/SKILL.md#error-handling) for merge conflicts
